...
namespace AdvancedApp.Models
{
    public class AdvancedContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Tells the EF Core to query the generated by SQL Server data (e.g. from triggers)
            // The [DatabaseGenerated(Computed)] attribute can be used as alternative to this method
            // call
            modelBuilder.Entity<Employee>().Property(e => e.GeneratedValue)
